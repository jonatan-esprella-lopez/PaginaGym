  ...
  return (
    <div className="gym-details-container">
      ...
      <div className="info-container">
        ...
        <InfoCard
          title="Accesorios necesarios"
          link="#"
          linkText="Comprar en tienda"
        >
          <p>
            Los materiales necesarios que usarás para llevar tu entrenamiento al
            siguiente nivel
          </p>
        </InfoCard>
      </div>

      <button className="estructure-size estructure-button-1 button-type-4 al">
