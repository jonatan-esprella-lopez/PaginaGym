...
const valoresData = [
  {
    icon: value1Icon,
    title: 'Disciplina',
    description: 'Fomentamos la disciplina en todos nuestros miembros.',
  },
  {
    icon: value2Icon,
    title: 'Esfuerzo',
    description:
      'Promovemos el esfuerzo constante para alcanzar metas personales.',
  },
  {
    icon: value3Icon,
    title: 'Pasión',
    description:
      'Nos apasiona ayudar a nuestros miembros a mejorar su bienestar.',
  },
  {
    icon: value4Icon,
    title: 'Compromiso',
    description:
      'Estamos comprometidos con el éxito y la satisfacción de nuestros miembros.',
  },
  {
    icon: value5Icon,
    title: 'Superación',
    description: 'Inspiramos a nuestros miembros a superarse día a día.',
  },
];
