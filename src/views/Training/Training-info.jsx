      ...
      <div className="training-info-container">
        ...
        <div className="training-details">
          ...
          <div className="training-text">
            <h3>CHIPPER</h3>
            <p>
              El entrenamiento CHIPPER es una secuencia de ejercicios que se
              realizan en un orden específico, completando una serie de
              repeticiones antes de pasar al siguiente ejercicio.
            </p>
            <h4>Duración:</h4>
            <p>30/40 minutos</p>
            <h4>Intensidad:</h4>
            ...
            <p>
              Asegúrate de calentar adecuadamente antes de comenzar el
              entrenamiento y enfriar después de finalizar. Mantén una
              hidratación adecuada durante toda la sesión.
            </p>
          </div>
        </div>
        <button
