              ...
              <div className="contenedeorSectionPerfil">
                <div className="contenedorDatosPortada">
                  <div className="contenedorNombre">
                    <p>
                      <strong>Jonatan</strong> Esprella
                    </p>
                  </div>
                  <div className="contenedorDescripcion">
                    <p>
                      La vida es un viaje lleno de experiencias, emociones y
                      aprendizajes. Es un camino que nos lleva a través de
                      altibajos, desafíos y momentos de alegría. Cada individuo
                      tiene su propia historia que contar, con sus propias
                      victorias y derrotas, sus sueños y aspiraciones. La vida
                      está llena de oportunidades para crecer, para amar, para
                      aprender y para explorar. Nos enfrentamos a decisiones
                      difíciles, pero también a momentos de felicidad y
                      realización. A medida que avanzamos, descubrimos más sobre
                      nosotros mismos, sobre los demás y sobre el mundo que nos
                      rodea.
                    </p>
                    <p>
                      La vida es un viaje lleno de experiencias, emociones y
